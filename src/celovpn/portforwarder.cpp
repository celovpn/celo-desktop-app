...
{
//    _reply.reset(_nam.get(BuildRequest(QUrl("https://celo.net/get_ports/" + QUrl::toPercentEncoding(_login, "", "") + "/" + QUrl::toPercentEncoding(_psw, "", "")))));
...
void PortForwarder::SetPort()
{
    if (_it_curr != _to_set.end()) {
        ...
        // - sets port1 for forwarding
//        _reply.reset(_nam.get(BuildRequest(QUrl("https://celo.net/ports/port"
